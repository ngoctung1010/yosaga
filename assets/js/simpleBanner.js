(function($,w)
{
	...
	$.fn.simpleBanner=function(cfg)
	{
		...
		$ul.css({width:width,overflow:'hidden',margin:0});
		$li.css({width:perWidth,height:'80%',float:'left',display:'block'});
		$img.css({width:'100%',height:'80%',display:'block',float:'right'});
